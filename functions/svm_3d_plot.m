...
z0 = reshape(z, size(x));
 ...
 [faces,verts,~] = isosurface(x0, y0, z0, f, .0, x0);
% p = patch(isosurface(x, y, z, f, .01, x));
 patch('Vertices', verts, 'Faces', faces, 'FaceColor','k','edgecolor', 'b', 'FaceAlpha', 0.2);
